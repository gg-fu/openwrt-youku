                     ...
                     unsigned int     timeout_ms)
{
    ...
    if (COAP_NETWORK_DTLS == network->type) {
        ...
        len =  HAL_UDP_recvfrom(network->fd, p_remote, p_data,  datalen, timeout_ms);
                         ...
                         unsigned int          timeout_ms)
{
   ...
   len = HAL_UDP_sendto(network->fd, p_remote , p_data, datalen, timeout_ms);
