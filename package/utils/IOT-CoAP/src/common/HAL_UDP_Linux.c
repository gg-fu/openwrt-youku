                 ...
                 unsigned int datalen)
{
  ...
  /////    ���ȡ��ָ����������������������, ���øýӿ�֮ǰ��Ҫ����HAL_UDP_connect()���ú�Դ��ַ�Ͷ˿�
...
int HAL_UDP_recvfrom(intptr_t sockfd,         //////   UDP socket���

                     NetworkAddr *p_remote,

                     unsigned char *p_data,   /////   ָ�����ݽ��ջ�������ָ��

                     unsigned int datalen,   /////   ���ջ��������ֽڴ�С

                     unsigned int timeout_ms  )    /////   �����ĳ�ʱʱ��, ��λms
...
int HAL_UDP_send(intptr_t sockfd,const unsigned char *p_data,unsigned int datalen,unsigned int timeout_ms)
{
...
int HAL_UDP_sendto(  intptr_t sockfd,    /////   UDP socket���

                    const NetworkAddr *p_remote,

                    const unsigned char *p_data,   /////   ָ���ݷ��ͻ�������ָ��

                   unsigned int datalen,   /////   ���������ݵ��ֽڳ���
 ...
 
{
  ...
  /////       = 0	��ָ����timeout_msʱ����, û���κ����ݷ��ͳɹ�

  /////       > 0	��ָ����timeout_msʱ����, ʵ�ʷ��͵������ֽ���
